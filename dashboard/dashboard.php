...
$totalMsg = getCount($conn, 'contacts', 'total_msg');
...
<section class="home_section">
    ...
    <div class="card-boxes">
        <div class="box">
            <div class="right_side" style="color:black;">
        ...
        <div class="box">
          ...
          <div class="box">
            <div class="right_side" style="color:black;">
                <div class="numbers"><?php echo  $totalMsg; ?></div>
                <div class="box_topic">Total Messages</div>
            </div>
            <i class='bx bx-message'></i>
        </div>
        </div>
                            ...
                            if ($result->num_rows > 0) {
                               ...
                               echo "<script>alert('Email already exists');</script>";
                                        ...
                                        if ($stmt) {
                                            ...
                                            // Execute statement
                                            if ($stmt->execute()) {
                                                echo "<script>window.location.pathname = 'gym/dashboard/dashboard.php';</script>";
                                                exit;
                                            } else {
